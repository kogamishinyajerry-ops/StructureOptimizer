...
### v1.0.0 → v1.1.0 → v1.2.0 详细变化

| 维度 | v1.0.0 | v1.1.0 | v1.2.0 | Δ (累计) |
|---|---:|---:|---:|---:|
| 1. 测试 | 5/25 | 20/25 | 20/25 | +15 |
| 2. 文档 | 11/15 | 11/15 | 11/15 | 0 |
| 3. 代码质量工具 | 0/15 | 15/15 | 15/15 | +15 |
| 4. CI / 可复现 | 2/10 | 2/10 | 10/10 | +8 |
| 5. 功能完成度 | 12/15 | 12/15 | 12/15 | 0 |
| 6. UX / CLI | 3/10 | 4/10 | 4/10 | +1 |
| 7. 工程卫生 | 9/10 | 10/10 | 10/10 | +1 |
| **总分** | **42** | **74** | **82** | **+40** |
